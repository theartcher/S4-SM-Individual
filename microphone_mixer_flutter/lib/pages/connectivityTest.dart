...
class ConnectivityRoute extends StatefulWidget {
  const ConnectivityRoute({super.key});

  @override
  State<ConnectivityRoute> createState() => _ConnectivityRouteState();
}

class _ConnectivityRouteState extends State<ConnectivityRoute>
